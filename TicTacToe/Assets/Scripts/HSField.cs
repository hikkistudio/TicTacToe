...
public class HSField : MonoBehaviour
{
    ...
    public void BackToMenu()
    {
        ...
        //Если мы находимся в игровом процессе, то сохраняемся
        if (GameController.GameState() == GameController.GameStateType.Play) {
            GameController.Pause();
        } else {
            //Во всех других состояниях нажатие данной кнопки равно окончанию игры
            EndGame();
        }
    }
